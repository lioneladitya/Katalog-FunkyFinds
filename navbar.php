    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="" class="text-decoration-none">
                <span class="h1 text-uppercase text-primary bg-dark px-2">Funky</span>
                <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Finds</span>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-6 text-right">
                ...
                <h5 class="m-0">+62 851-7308-3772</h5>
        </div>
    </div>
</div>
   <!-- Topbar End -->
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Funky</span>
                        <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Finds</span>
                    </a>
