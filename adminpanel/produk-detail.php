        ...
        <div class="col-12 col-md-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <img src="../image/<?php echo $data['foto'] ?>" alt="" width="300px" height="300px">
                </div>
                <div>
                ...
                <div>
                    <label for="ketersedian_stok">Ketersedian_Stok</label>
            ...
            <?php
                    ...
                    $queryUpdate = mysqli_query($conn, "UPDATE produk SET kategori_id='$kategori', nama='$nama', harga='$harga', detail='$detail', 
                    ketersedian_stok='$ketersedian_stok' WHERE id=$id");
                    ...
                    <?php
                                ...
                                $queryUpdate = mysqli_query($conn, "UPDATE kategori SET foto='$new_name' WHERE id='$id'");
